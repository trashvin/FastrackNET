CREATE VIEW [dbo].[vwAssetAssignmentsForCustodians]
	AS SELECT        dbo.AssetAssignment.AssetAssignmentID, dbo.AssetAssignment.EmployeeID, dbo.AssetAssignment.FixAssetID, dbo.FixAsset.Model, dbo.FixAsset.SerialNumber, dbo.FixAsset.AssetTag, dbo.FixAsset.Brand, 
                         ...
                         dbo.AccessRight.EmployeeID AS AdminID, dbo.AccessRight.DepartmentID, dbo.AssetAssignment.FromID, dbo.AssetAssignment.ToID
...
WHERE        (dbo.AccessRight.AccessLevel = 1) AND (dbo.FixAsset.AssetStatusID = 7) AND (dbo.AssetAssignment.AssignmentStatusID = 2)